...
public final class JournalReportDtoComparators {
    ...
    static Map<Key, Comparator<JournalReportDto>> map = new HashMap<>();
    ...
    public static Comparator<JournalReportDto> getComparator(String name, Direction dir) {
        return map.get(new Key(name, dir));
    }

    private JournalReportDtoComparators() {
    }
}
