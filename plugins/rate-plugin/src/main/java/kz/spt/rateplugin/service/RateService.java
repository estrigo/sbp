...
public interface RateService {
    ...
    BigDecimal calculatePayment(Long parkingId, Date inDate, Date outDate, Boolean cashlessPayment, Boolean isCheck, String payments, String carType) throws JsonProcessingException;
