...
public class ParkingRate {
    ...
    public enum RateType {
        ...
        INTERVAL_OLD,
        DIMENSIONS_BY_INTERVAL //тариф по габаритам в зависимости от часов заезд  - легковые,микроавтобусы, грузовики
                                //например каждый час между 08.00 - 16.00 по 500тг, между 16.00 - 08.00 по 1000тг
    }
