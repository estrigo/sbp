 ...
 * if either the related plugin is not a {@link org.pf4j.spring.SpringPlugin} or the given plugin manager is not a
...
public class SpringExtensionFactory implements ExtensionFactory {
     ...
     * <ol>
     *     <li>If the given {@code extensionClass} belongs to a plugin that is a {@link org.pf4j.spring.SpringPlugin} the plugins context will be returned.</li>
    ...
    protected <T> Optional<ApplicationContext> getApplicationContextBy(final Class<T> extensionClass) {
        ...
        if (plugin instanceof org.pf4j.spring.SpringPlugin) {
