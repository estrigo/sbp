...
public interface AbonomentService {
	...
	JsonNode createAbonomentType(int period, String customJson, String type, int price, UserDetails currentUser) throws Exception;

	JsonNode deleteAbonomentType(Long id) throws Exception;

	JsonNode createAbonoment(String platenumber, Long parkingId, Long typeId, String dateStart, Boolean checked, UserDetails currentUser) throws Exception;
