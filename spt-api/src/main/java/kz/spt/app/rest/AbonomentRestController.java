...
public class AbonomentRestController {
	...
	public JsonNode createAbonomentType(@RequestParam("period") int period,
		...
		return abonomentService.createAbonomentType(period, customJson, type, price, currentUser);
	}
	...
	public JsonNode createAbonoment(@RequestParam("platenumber") String platenumber,
									...
									@AuthenticationPrincipal UserDetails currentUser) throws Exception {
		return abonomentService.createAbonoment(platenumber, parkingId, typeId, dateStart, checked, currentUser);
	}
